...
import net.bhpachulski.tddcriteriaserver.model.Eclemma.Type;
...
public class AnaliseTrialAntiga {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String folderBase = "/Users/bhpachulski/Documents/workspaceExperimentos/";
        String coverageFile = "/tddCriteria/coverageTrack/";
        String jUnitFile = "/tddCriteria/junitTrack/";
        
        File fFolderBase = new File(folderBase);
